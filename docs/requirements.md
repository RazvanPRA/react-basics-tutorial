...
Listă ordonată, ajustabilă pe parcurs. Acesta este singurul loc unde traseul este definit; `README.md` și `GPT.md` trimit aici.
...
- `GPT.md` și `.github/copilot-instructions.md` nu au voie să divergă; sincronizarea este impusă de script (`scripts/sync-ai-instructions.sh`).
